...
var checkBotInUserAgent = function (userAgent) {
    if (userAgent.indexOf('Bot') > -1) {
        console.log('HAS BOT WORD');
    } else {
    botPoints++;
    }
};
...
module.exports = function(params) {
    ...
    checkBotInUserAgent(params.user_agent);
